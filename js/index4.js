     ...
     onGetTasks( (datafomDB) => {
        ...
        datafomDB.forEach(doc => { 
            ...
            if(taskWithMulta.LibIdentificador == IdBUsInsp){
                ...
                <br/>
                <button class='btn-delete'  ">Libreta equivocada</button>
                <button class='btn-Edit' data-id="${doc.id}">Sancionar</button>
                <div>
                </div>
              </div>`;
                console.log('match')
                ...
                onGetTasks((datafomDB) =>{
                    ...
                    datafomDB.forEach(doc =>{
                        ...
                        if(taskWithCap.LibIdentificador == IdBusInstrUpp){
                            ...
                            <br/>
                            <button class='btn-inst-delete'>Libreta equivocada</button>
                            <button class='btn-inst-Edit' data-id"${doc.id}">Aprobar</button>
                            </div>
                            `;
